...
(function(factory) {
    ...
    (function(Highcharts) {
        ...
        // imagesMy in the SVG to data URIs. The options and chartOptions arguments are
        ...
        Highcharts.Chart.prototype.getSVGForLocalExport = function(
            ...
            try {
                // If there are no imagesMy to embed, the SVG is okay now.
                if (!images.length) {
                ...
                // Go through the imagesMy we want to embed
        ...
        Highcharts.Chart.prototype.exportChartLocal = function(
            ...
            // Always fall back on:
            // - MS browsers: Embedded imagesMy JPEG/PNG, or any PDF
            // - Embedded imagesMy and PDF
            if (
                (
                    isMSBrowser &&
                    (
